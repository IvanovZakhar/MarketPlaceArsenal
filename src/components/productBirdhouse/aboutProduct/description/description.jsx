...
const Description = ({productBirdhouse}) => {
    ...
    const elem = (productBirdhouse) => {
        ...
        const handleToggleFavourite = () => {
            toggleFavourite(productBirdhouse);
          };
          
        const isFavourite = favourites.some((favourite) => favourite.article === article);
    ...
    const item = productBirdhouse ? elem(productBirdhouse[0]) : null
    return (
       <>
         {item}
       </>
